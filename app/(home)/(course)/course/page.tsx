   ...
   return (
      <>
         <section className="my-8">
            <div className="container lg:px-20">
               <div className="flex space-y-6 flex-col">
                  <h1 className="text-xl md:text-2xl lg:text-4xl font-semibold text-center md:text-left text-black">Belajar dengan harga terjangkau</h1>
                  <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-[1.88rem]">
         ...
         <section className="my-8">
            <div className="container lg:px-20">
               <div className="flex space-y-6 flex-col">
                  <h1 className="text-4xl font-semibold text-black">Pilih jalur sesuai minatmu</h1>
                  <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-[1.12rem]">
